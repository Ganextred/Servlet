...
<%--        <h2 > <a href="/admin/adminPanel" class="tbtn"  ><p ${lang.gL()ADMIN}" style="position: relative; top: -4px;"/> </a></h2>--%>
<%--    </div>--%>
            ...
            <div th:each="apartment : ${apartments}" class="col-lg-4 col-md-6">
                <div class="room-item">
                    ...
                    <div class="ri-text">
                        ...
                        <a href="@{'apartment/'(apartment = ${apartment.getId()})}" class="primary-btn">${lang.gL("moreDetails")}</a>
                    </div>
                </div>
            </div>
            </c:forEach>
